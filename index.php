...
<body>
  ...
  <hr class="linhaprata">
    ...
    <div class="sponsors-container">
      ...
      <ul class="sponsors-list">
          <li class="sponsor-item">
              <a href="https://www.instagram.com/wbd_veiculos_?igsh=MWJjaGV3Nzd6cHcxMQ==" target="_blank" title="WBD Veículos">
          ...
          <li class="sponsor-item">
              <a href="https://www.instagram.com/wilianbarerefeicoes?igsh=MTZ5cXE2OWRhMTlsZQ==" target="_blank" title="WILIAN bar e refeições">
          ...
          <li class="sponsor-item">
              <a href="https://www.instagram.com/material_de_construcao5marias?igsh=dXVxNWdhMnVpbGk2" target="_blank" title="5 MARIAS Material de construção">
                  <img src="img/patrocinadores/materialdeconstrucao2.jpg" alt="5 MARIAS MATERIAL DE CONSTRUÇÃO">
              </a>
          </li>
          <li class="sponsor-item">
              <a href="https://www.instagram.com/projeto_vilela?igsh=b2p5eXp2bmRnNm11" target="_blank" title="Projeto VILELA">
          ...
          <li class="sponsor-item">
              <a href="https://www.instagram.com/dscentroautomotivo_rj?igsh=MWV1YXd3Y202Y25m" target="_blank" title="DS Centro Automotivo">
    ...
    <div class="sponsors-container">
        ...
        <ul class="sponsors-list">
            <li class="sponsor-item">
                <a href="https://www.instagram.com/viniciusng_barbee?igsh=amtlcDJiMXE0Nmd6" target="_blank" title="Barbeshop Vinicius Negão">
                    <img src="img/patrocinadores/barbeshop.jpg" alt="Barbeshop Vinicius Negão">
                </a>
            </li>
            <li class="sponsor-item">
                <a href="https://www.instagram.com/dinizmultimarcasrj?igsh=bHpiNWN0NW54dG9x" target="_blank" title="Diniz Multi marcas">
            ...
            <li class="sponsor-item">
                <a href="https://www.instagram.com/mansao.21?igsh=MXUxZnZsZmVmcDVjbw==" target="_blank" title="Mansao021">
            ...
            <li class="sponsor-item">
                <a href="https://www.instagram.com/vsouzaconstrucao?igsh=MWhoeWhiemNiNW45eg==" target="_blank" title="VSouza Construções e Reformas">
                    <img src="img/patrocinadores/valquir.jpg" alt="VSouza Construções e Reformas">
                </a>
            </li>
            <li class="sponsor-item">
                <a href="https://www.instagram.com/studiodebeleza_daniellecosta?igsh=eHFhMDh0cjYxa2Zs" target="_blank" title="Studio de Beleza Daniele Costa">
